...
Look up a song title courtesy of the Spotify API by inputing `node liri.js spotify-this-song '<song name here>'`.

Look up some movie information courtesy of the OMDB API by inputing `node liri.js movie-this '<movie name here>'`.
